...
public class ToughJetService {
	...
	public List<ToughJetResponse> getToughJetResponse(@RequestBody ToughJetRequest request) {
		...
		firstResponse.setInboundDateTime(LocalDateTime.of((request.getInboundDate() == null ? LocalDate.now() : request.getInboundDate()), LocalTime.now()).toInstant(ZoneOffset.UTC));
		firstResponse.setOutboundDateTime(LocalDateTime.of((request.getOutboundDate() == null ? LocalDate.now() : request.getOutboundDate()), LocalTime.now()).toInstant(ZoneOffset.UTC));
		...
		secondResponse.setInboundDateTime(LocalDateTime.of((request.getInboundDate() == null ? LocalDate.now() : request.getInboundDate()), LocalTime.now()).toInstant(ZoneOffset.UTC));
		secondResponse.setOutboundDateTime(LocalDateTime.of((request.getOutboundDate() == null ? LocalDate.now() : request.getOutboundDate()), LocalTime.now()).toInstant(ZoneOffset.UTC));
